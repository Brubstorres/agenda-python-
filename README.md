...
Este projeto foi elaborado para permitir o aprendizado de conceitos como o padrão de projeto MVC (Model-View-Controller), framework Flask e seus componentes, variaveis de ambiente, paradigma de programação orientado a objetos e reforço de fundamentos da linguagem de programação Pyton.
...
4. Crie, preferncialmente, um ambiente virtual utilizando uma versão do Python >3.12.10:
